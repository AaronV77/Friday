...
/*
 * This function will loop through the undefined variables in the kprintf 
 * - function. How this function will work is by looping through the 
 * - string looking for the % symbols and the character that comes after
 * - it. The system will then handle the first argument that is in the list
 * - properly.
 */
...
/*
 * This function is the main kernel printing to the screen mechanism. How
 * - this function will work is by gather all the extra parameters that is 
 * - passed like the normal printf function to the __kprintf_va_list function.
 */
