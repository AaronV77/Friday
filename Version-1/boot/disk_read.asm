...
disk_read:
	...
	jne disk_read_error							; If the previous line did not match then call the disk_read_error procedure.
...
disk_read_error:
	...
	mov bx, DISK_READ_ERROR_MSG					; Load our disk error message for output.
...
DISK_READ_ERROR_MSG: db "Disk read error!", 0	; Save a byte for our disk read error message. 
