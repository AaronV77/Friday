...
void paging_install()
{
    ...
    // int mem_end_page = 0x1000000; // 16777216
    // nframes = mem_end_page / 0x1000;                        // 16777216 / 4096 = 4096
    // frames = (int*)kmalloc(INDEX_FROM_BIT(nframes), 0, 0);  // 4096 / 32 = 128
    // memset(frames, 0, INDEX_FROM_BIT(nframes));             // Fill the "frames" with 128 zero's.
    
    // // Let's make a page directory.
    // int phys;
    // kernel_directory = (page_directory_t*)kmalloc_a(sizeof(page_directory_t));
    // memset(kernel_directory, 0, sizeof(page_directory_t));
    // kernel_directory->physicalAddr = (int)kernel_directory->tablesPhysical;
...
// static page_table_t *clone_table(page_table_t *src, int *physAddr)
// {
...
//     int offset = (int)dir->tablesPhysical - (int)dir;
